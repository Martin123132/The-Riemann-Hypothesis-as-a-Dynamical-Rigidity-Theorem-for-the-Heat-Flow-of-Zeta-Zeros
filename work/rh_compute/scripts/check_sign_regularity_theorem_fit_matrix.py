...
REQUIRED_STRINGS = (
    ...
    "The obligation ledger splits the target into `10` rows",
    "`jwpf_06_sign_regular_to_jensen_pf_conversion`",
    "finite evidence rows are",
...
def validate(path: Path) -> list[FitMatrixIssue]:
    ...
    for ref in (
        ...
        "work/rh_compute/scripts/check_jensen_window_pf_bridge_obligations.py",
        "work/rh_compute/scripts/check_jensen_window_pf_theorem_machinery_fit_matrix.py",
