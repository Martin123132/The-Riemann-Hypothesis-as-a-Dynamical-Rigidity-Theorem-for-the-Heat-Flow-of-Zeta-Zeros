#!/usr/bin/env python3
"""Build a hundredth-tile H2-H22 pilot collar for order ten."""
...
base.DEFAULT_CACHE = (
    ...
    "jensen_window_pf_compound_order10_shifted_jet_pilot_h2_h22_hundredth_tiles.jsonl"
)
base.DEFAULT_MANIFEST = (
    base.REPO_ROOT
    / "work/rh_compute/results/"
    "jensen_window_pf_compound_order10_shifted_jet_pilot_h2_h22_hundredth_cache.json"
)
base.CACHE_TILE_LABEL = "order10_pilot_hundredth"
