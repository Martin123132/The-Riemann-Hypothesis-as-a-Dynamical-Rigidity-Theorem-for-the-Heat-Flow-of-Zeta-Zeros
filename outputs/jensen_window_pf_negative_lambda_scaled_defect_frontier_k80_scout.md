...
```text
python work/rh_compute/scripts/check_jensen_window_pf_negative_lambda_scaled_defect_frontier_scout.py --target work/rh_compute/results/jensen_window_pf_negative_lambda_scaled_defect_frontier_k80_scout.json --note outputs/jensen_window_pf_negative_lambda_scaled_defect_frontier_k80_scout.md
```
...
exact cone rows: 237 / 237
half-width rows: 237 / 237
one-third rows: 159 / 237
one-third failure rows: 78
...
```text
lambda=-100.0: one-third 79/79, first failure none, max s=2.977652354253333487E-1 at k=79
lambda=-50.0: one-third 50/79, first failure k=51, margin=-2.719207370662713847E-4, max s=3.925861927936712254E-1 at k=79
lambda=-25.0: one-third 30/79, first failure k=31, margin=-1.768768251686068314E-3, max s=4.455413929570771097E-1 at k=79
```
...
min half-width margin: 5.445860704292289032E-2 at lambda=-25.0, k=79
min one-third margin: -1.122080596237437763E-1 at lambda=-25.0, k=79
max scaled defect: 4.455413929570771097E-1 at lambda=-25.0, k=79
min scaled-defect increase: 1.410831113285100353E-3 at lambda=-25.0, k=78
```

## Consequence

On the k80 negative-lambda prefix, the exact scaled-defect cone 0<=s_k<=1 and the half-width buffer s_k<=1/2 hold on every checked row, while the one-third buffer holds on only 159/237 rows. Thus the previous one-third sufficient route is too strong for the observed prefix; any analytic tail theorem should target the exact cone or a weaker buffer such as one-half.
