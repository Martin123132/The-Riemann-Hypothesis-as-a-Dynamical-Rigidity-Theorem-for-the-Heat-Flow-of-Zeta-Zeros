...
work/rh_compute/results/acb_enclosures_negative_lambda_cone_entry_lam_m25_m50_m100_k0_k150_summary.json
```
...
```text
python work/rh_compute/scripts/check_jensen_window_pf_negative_lambda_cone_entry_prefix_scout.py --target work/rh_compute/results/jensen_window_pf_negative_lambda_cone_entry_prefix_k150_scout.json --note outputs/jensen_window_pf_negative_lambda_cone_entry_prefix_k150_scout.md
```
...
lower and upper walls: 1 <= k <= 149
monotone wall: 1 <= k <= 148
```

The coefficient enclosures were generated by:

```text
python work/rh_compute/scripts/acb_coefficient_enclosures.py --lambdas=-25,-50,-100 --k-min 0 --k-max 150 --n-sum 50 --cutoff 6 --dps 160 --digits 80 --abs-tol 1e-110 --constant-terms 30 --output-dir work/rh_compute/results --run-id acb_enclosures_negative_lambda_cone_entry_lam_m25_m50_m100_k0_k150 --overwrite
```

## Certified Margins

```text
lower wall rows: 447 / 447
upper wall rows: 447 / 447
monotone gap rows: 444 / 444

minimum lower-wall margin:
  3.270410744476329767E-3 at lambda=-25.0, k=149

minimum upper-wall margin:
  2.649335028912244806E-3 at lambda=-100.0, k=149
