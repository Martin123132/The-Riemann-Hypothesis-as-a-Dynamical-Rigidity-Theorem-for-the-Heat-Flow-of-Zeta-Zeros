...
work/rh_compute/results/acb_enclosures_negative_lambda_cone_entry_lam_m25_m50_m100_k0_k60_summary.json
```
...
```text
python work/rh_compute/scripts/check_jensen_window_pf_negative_lambda_cone_entry_prefix_scout.py --target work/rh_compute/results/jensen_window_pf_negative_lambda_cone_entry_prefix_k60_scout.json --note outputs/jensen_window_pf_negative_lambda_cone_entry_prefix_k60_scout.md
```
...
lower and upper walls: 1 <= k <= 59
monotone wall: 1 <= k <= 58
```

The coefficient enclosures were generated by:

```text
python work/rh_compute/scripts/acb_coefficient_enclosures.py --lambdas=-25,-50,-100 --k-min 0 --k-max 60 --n-sum 50 --cutoff 6 --dps 160 --digits 80 --abs-tol 1e-110 --constant-terms 30 --output-dir work/rh_compute/results --run-id acb_enclosures_negative_lambda_cone_entry_lam_m25_m50_m100_k0_k60 --overwrite
```

## Certified Margins

```text
lower wall rows: 177 / 177
upper wall rows: 177 / 177
monotone gap rows: 174 / 174

minimum lower-wall margin:
  9.875541374763750245E-3 at lambda=-25.0, k=59

minimum upper-wall margin:
  4.268538754539301236E-3 at lambda=-100.0, k=59
