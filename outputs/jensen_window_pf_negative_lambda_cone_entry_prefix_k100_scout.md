...
work/rh_compute/results/acb_enclosures_negative_lambda_cone_entry_lam_m25_m50_m100_k0_k100_summary.json
```
...
```text
python work/rh_compute/scripts/check_jensen_window_pf_negative_lambda_cone_entry_prefix_scout.py --target work/rh_compute/results/jensen_window_pf_negative_lambda_cone_entry_prefix_k100_scout.json --note outputs/jensen_window_pf_negative_lambda_cone_entry_prefix_k100_scout.md
```
...
lower and upper walls: 1 <= k <= 99
monotone wall: 1 <= k <= 98
```

The coefficient enclosures were generated by:

```text
python work/rh_compute/scripts/acb_coefficient_enclosures.py --lambdas=-25,-50,-100 --k-min 0 --k-max 100 --n-sum 50 --cutoff 6 --dps 160 --digits 80 --abs-tol 1e-110 --constant-terms 30 --output-dir work/rh_compute/results --run-id acb_enclosures_negative_lambda_cone_entry_lam_m25_m50_m100_k0_k100 --overwrite
```

## Certified Margins

```text
lower wall rows: 297 / 297
upper wall rows: 297 / 297
monotone gap rows: 294 / 294

minimum lower-wall margin:
  5.327206185304592098E-3 at lambda=-25.0, k=99

minimum upper-wall margin:
  3.344271151404132469E-3 at lambda=-100.0, k=99
